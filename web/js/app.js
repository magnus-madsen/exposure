...
var App = React.createClass({displayName: "App",
    ...
    render: function () {
        ...
        else return (React.createElement(Album, {name: this.state.name, 
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "album"}, 
                React.createElement("div", {className: "album-name"}, this.props.name), 

                React.createElement(Breadcrumb, {location: this.props.location, clickFolder: this.props.clickFolder}), 

                React.createElement("div", {className: "album-items"}, 
                    this.props.folders.map(item =>
                        React.createElement(Folder, {key: item.url, 
                                name: item.name, 
                                path: item.path, 
                                time: item.time, 
                                url: item.url, 
                    ...
                    this.props.images.map(item =>
                        React.createElement(Image, {key: item.url, 
                               name: item.name, 
                               url: item.url, 
    ...
    render: function () {
        return (
            React.createElement("div", {className: "breadcrumb"}, 
                React.createElement("span", {className: "fragment"}, 
                    React.createElement("a", {href: "#", onClick: () => this.props.clickFolder("/")}, "Home")
                ), 
                ...
                this.props.location.map((fragment, index) => {
                    ...
                    return (
                        React.createElement("span", {key: index}, 
                            React.createElement("span", {className: "fa fa-angle-right spacer"}), 
                            React.createElement("span", {className: "fragment"}, 
...
var Folder = React.createClass({displayName: "Folder",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "folder-item", style: style, onClick: () => this.props.clickFolder(this.props.path)}, 
                React.createElement("div", {className: "folder-text"}, 
                    React.createElement("div", {className: "folder-name"}, this.props.name), 
                    React.createElement("div", {className: "folder-date"}, this.getFormattedTime())
                )
            )
        )
    }
...
var Image = React.createClass({displayName: "Image",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "image-item", onClick: () => this.props.clickImage(this.props.name)}, 
                React.createElement("img", {src: url, className: "image"})
            )
        );
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "lightbox"}, 
                React.createElement("div", {className: "lightbox-prev", onClick: this.props.clickPrev}, 
                    React.createElement("div", {className: "fa fa-chevron-left fa-3x left-arrow"})
                ), 
                React.createElement("div", {className: "lightbox-container", onClick: this.props.clickEsc}, 
                    React.createElement("img", {src: url, onClick: (e) => {
                ...
                React.createElement("div", {className: "lightbox-next", onClick: this.props.clickNext}, 
                    React.createElement("div", {className: "fa fa-chevron-right fa-3x right-arrow"})
                )
            )
        );
    }
